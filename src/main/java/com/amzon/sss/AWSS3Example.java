...
public class AWSS3Example {
	...
	public static void main(String[] args) {
		...
		String bucketName = "test-bucket1132";
		...
		String fileName = folderName + SUFFIX + "excel.xlsx";
		s3client.putObject(
				new PutObjectRequest(bucketName, fileName, new File("C:\\Users\\Bimal\\Desktop\\excel.xlsx"))
